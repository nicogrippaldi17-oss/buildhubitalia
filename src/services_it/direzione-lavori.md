...
features:
  - text: "Supervisione lavori"
    tip: "Controlliamo che le opere vengano eseguite nel rispetto del progetto e delle prescrizioni tecniche."
  - text: "Verifica esecuzione"
    tip: "Monitoriamo la qualità delle lavorazioni e la corretta realizzazione degli interventi previsti."
  - text: "Coordinamento imprese"
    tip: "Favoriamo la collaborazione tra le diverse imprese coinvolte per garantire continuità e organizzazione nel cantiere."
  - text: "Gestione varianti"
    tip: "Valutiamo e coordiniamo eventuali modifiche che si rendano necessarie durante l'esecuzione dei lavori."
  - text: "Verifiche tecniche"
    tip: "Effettuiamo controlli periodici per monitorare conformità, qualità e corretto avanzamento delle opere."
order: 3
---
